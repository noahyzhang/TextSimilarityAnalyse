...
//
//
//void TestShowWordFreq()    //测试打印出两个文档的词频
//{
...
//	{
//		cout << argc << endl;
//		cout << "请输入函数名," << "文档1的地址," << "文档2的地址," << endl;
//		return 0;
//	}
//	TextSimilarity tsy;  //构建对象
//	const char* txt1 = (const char*)argv[1];
//	const char* txt2 = (const char*)argv[2];
//	double res = tsy.GetCosine(txt1, txt2);
//	cout<<"两个文档的相似度：" << res << endl;
//	return 0;
//}